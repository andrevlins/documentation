...
>**Note:** You may be concerned about the tediousness of having to import things into each view. Remember, during the bootstrapping phase you can configure Aurelia with global resources to be available in every view. Just use `aurelia.use.globalizeResources(...resourcePaths)`.
...
* Use the Aurelia object during your bootstrapping phase to call `aurelia.use.globalizeResources(...resourcePaths)` to register extensions with global visibility in your application.
